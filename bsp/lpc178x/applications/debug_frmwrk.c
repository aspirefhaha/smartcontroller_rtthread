...
void (*_db_msg)(LPC_UART_TypeDef* UartID, const void *s);
void (*_db_msg_)(LPC_UART_TypeDef* UartID, const void *s);
void (*_db_char)(LPC_UART_TypeDef* UartID, uint8_t ch);
void (*_db_dec)(LPC_UART_TypeDef* UartID, uint8_t decn);
void (*_db_dec_16)(LPC_UART_TypeDef* UartID, uint16_t decn);
void (*_db_dec_32)(LPC_UART_TypeDef* UartID, uint32_t decn);
void (*_db_hex)(LPC_UART_TypeDef* UartID, uint8_t hexn);
void (*_db_hex_16)(LPC_UART_TypeDef* UartID, uint16_t hexn);
void (*_db_hex_32)(LPC_UART_TypeDef* UartID, uint32_t hexn);
void (*_db_hex_)(LPC_UART_TypeDef* UartID, uint8_t hexn);
void (*_db_hex_16_)(LPC_UART_TypeDef* UartID, uint16_t hexn);
void (*_db_hex_32_)(LPC_UART_TypeDef* UartID, uint32_t hexn);

uint8_t (*_db_get_char)(LPC_UART_TypeDef* UartID);
Bool (*_db_get_char_nonblocking)(LPC_UART_TypeDef* UartID, uint8_t* c);
uint8_t (*_db_get_val)(LPC_UART_TypeDef* UartID, uint8_t option, uint8_t numCh, uint32_t * val);
 ...
 * @return		None
 **********************************************************************/
void UARTPutChar (LPC_UART_TypeDef* UartID, uint8_t ch)
{
 ...
 **********************************************************************/
uint8_t UARTGetChar (LPC_UART_TypeDef* UartID)
{
	uint8_t tmp = 0;
...
Bool UARTGetCharInNonBlock(LPC_UART_TypeDef* UartID, uint8_t* c)
{	
    if(c == NULL)
        return FALSE;		
 ...
 * @return		character value that returned
 **********************************************************************/
uint8_t UARTGetValue (LPC_UART_TypeDef* UartID, uint8_t option,
 ...
 * @return		None
 **********************************************************************/
void UARTPuts(LPC_UART_TypeDef* UartID, const void *str)
{
 ...
 * @return		None
 **********************************************************************/
void UARTPuts_(LPC_UART_TypeDef* UartID, const void *str)
{
	UARTPuts (UartID, str);
	UARTPuts (UartID, "\n\r");
}
 ...
 * @return		None
 **********************************************************************/
void UARTPutDec(LPC_UART_TypeDef* UartID, uint8_t decnum)
{
 ...
 * @return		None
 **********************************************************************/
void UARTPutDec16(LPC_UART_TypeDef* UartID, uint16_t decnum)
{
	uint8_t c1=decnum%10;
	uint8_t c2=(decnum/10)%10;
	uint8_t c3=(decnum/100)%10;
 ...
 * @return		None
 **********************************************************************/
void UARTPutDec32(LPC_UART_TypeDef* UartID, uint32_t decnum)
{
	uint8_t c1=decnum%10;
	uint8_t c2=(decnum/10)%10;
	uint8_t c3=(decnum/100)%10;
 ...
 * @return		None
 **********************************************************************/
void UARTPutHex_ (LPC_UART_TypeDef* UartID, uint8_t hexnum)
{
	uint8_t nibble, i;
 ...
 * @return		None
 **********************************************************************/
void UARTPutHex (LPC_UART_TypeDef* UartID, uint8_t hexnum)
{
	uint8_t nibble, i;
 ...
 * @return		None
 **********************************************************************/
void UARTPutHex16_ (LPC_UART_TypeDef* UartID, uint16_t hexnum)
{
	uint8_t nibble, i;
 ...
 * @return		None
 **********************************************************************/
void UARTPutHex16 (LPC_UART_TypeDef* UartID, uint16_t hexnum)
{
	uint8_t nibble, i;
 ...
 * @return		None
 **********************************************************************/
void UARTPutHex32_ (LPC_UART_TypeDef* UartID, uint32_t hexnum)
{
	uint8_t nibble, i;
 ...
 * @return		None
 **********************************************************************/
void UARTPutHex32 (LPC_UART_TypeDef* UartID, uint32_t hexnum)
{
	uint8_t nibble, i;
