...
/* Peripheral group ----------------------------------------------------------- */
#ifndef LPC178X_ADC_H_
#define LPC178X_ADC_H_
 ...
 */
#define ADC_DR_CHN(n)			((n&0x7)<<24)
#define ADC_DR_CHNMASK			(0x7 << 24)
...
uint32_t ADC_GlobalGetChn(LPC_ADC_TypeDef * ADCx);
